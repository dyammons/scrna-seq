...
To install you can use a `pip` command inside a relavent `conda env` (check out the [source](https://pachterlab.github.io/kallistobustools/) if you have problems with install or usage).
```sh
conda activate <xxx>
```
```sh
